import{A as St,B as kt,C as Q,D as Et,E as $t,G as _t,H as Pe,I as Tt,J as ce,K as Pt,L as Mt,M as Ot,N as Lt,O as Dt,a as C,b as E,c as ke,d as I,e as Ee,f as Ze,h as $e,i as _e,j as ut,l as mt,m as X,n as le,o as bt,p as ft,q as Te,r as vt,s as yt,t as wt,u as xt,v as x,w as k,x as T,y as F,z as Ct}from"./chunk-SI6IXCS7.js";var It=[{path:"feature1",loadChildren:()=>import("./chunk-L5JIRYEU.js").then(t=>t.Feature1Module)},{path:"feature2",loadChildren:()=>import("./chunk-CIWK2RE6.js").then(t=>t.Feature2Module)},{path:"feature3",loadChildren:()=>import("./chunk-KBJ5VTB3.js").then(t=>t.Feature3Module)}];var L=class{static intersect(t,e){let i=Math.max(t.left,e.left),n=Math.min(t.right,e.right),s=Math.max(t.top,e.top),o=Math.min(t.bottom,e.bottom),r=Math.max(0,n-i),c=Math.max(0,o-s);return new DOMRect(i,s,r,c)}static clip(t,e){let i=E(C({},t.toJSON()),{top:t.top+e.top,left:t.left+e.left,bottom:t.bottom-e.bottom,right:t.right-e.right});return i.width=i.right-i.left,i.height=i.bottom-i.top,i}static clipOffsets(t,e){return{top:e.top-t.top,left:e.left-t.left,bottom:t.bottom-e.bottom,right:t.right-e.right}}static equals(t,e){return t==null||e==null?t===e:t.x===e.x&&t.y===e.y&&t.width===e.width&&t.height===e.height}static sizeEqual(t,e){return Math.round(t.width)===Math.round(e.width)&&Math.round(t.height)===Math.round(e.height)}},de=-1,At=1-de*2;function Ei(t,e){let i=Math.max(t.width,At),n=Math.max(t.height,At),s=t.top-e.top-de,o=t.left-e.left-de,r=e.right-t.left-i-de,c=e.bottom-t.top-n-de;return`${-Math.round(s)}px ${-Math.round(r)}px ${-Math.round(c)}px ${-Math.round(o)}px`}var Rt=[...Array.from({length:1e3},(t,e)=>e/1e3),1],$i=class{constructor(t,e,i){this.#i=e,this.#t=i,this.#n=i.clientRect,this.#s(t)}#i;#e=void 0;#t;#n;#r=void 0;get visibleRect(){let t=this.#t.clip;return t?L.clip(this.#n,t):this.#n}get isIntersecting(){let{width:t,height:e}=this.visibleRect;return t>0&&e>0}#s(t){let{root:e,rootBounds:i}=this.#t,{visibleRect:n}=this;this.#e?.disconnect(),this.#e=new IntersectionObserver(this.#o,{root:e,rootMargin:Ei(n,i),threshold:Rt}),this.#e.observe(t)}#o=t=>{if(!this.#e)return;let e=t[t.length-1];if(e){let{intersectionRatio:i,boundingClientRect:n}=e,s=this.#n;this.#n=n;let o=this.#r,r=!L.equals(n,s);if(i!==this.#r||r){let c=this.#t.rootBounds,l=L.intersect(n,c),h=l.width>0&&l.height>0;if(!h)return;this.#r=i,(o!=null||r)&&(this.#i(new _i(e.target,n,e.intersectionRect,h,c),this),this.#s(e.target))}}};disconnect(){this.#e?.disconnect()}},_i=class{constructor(t,e,i,n,s){this.target=t,this.boundingClientRect=e,this.intersectionRect=i,this.isIntersecting=n,this.rootBounds=s}},Ti=class{constructor(t,e){let i=Oi(t);if(Pi(i)){let n=i.ownerDocument??document;this.rootBounds=i.getBoundingClientRect(),this.#i=new ResizeObserver(s=>{for(let o of s){let[{inlineSize:r,blockSize:c}]=o.borderBoxSize;if(L.sizeEqual(this.rootBounds,{width:r,height:c}))continue;let l=o.target.getBoundingClientRect();this.rootBounds=l,e(l,this)}}),this.#i.observe(i),n.addEventListener("scroll",s=>{s.target&&s.target!==i&&Ut(s.target)&&s.target.contains(i)&&(this.rootBounds=i.getBoundingClientRect(),e(this.rootBounds,this))},{capture:!0,passive:!0,signal:this.#e.signal})}else{let n=i.visualViewport??i;this.rootBounds=jt(i);let s=()=>{let o=jt(i);L.equals(this.rootBounds,o)||(this.rootBounds=o,e(o,this))};n.addEventListener("resize",s,{signal:this.#e.signal})}}#i;#e=new AbortController;rootBounds;disconnect(){this.#i?.disconnect(),this.#e.abort()}};function jt(t){let e=t.visualViewport?.width??t.innerWidth,i=t.visualViewport?.height??t.innerHeight;return new DOMRect(0,0,e,i)}function Ut(t){return"nodeType"in t}function Pi(t){return Ut(t)&&t.nodeType===Node.ELEMENT_NODE}function Mi(t){return t.nodeType===Node.DOCUMENT_NODE}function Oi(t){return!t||Mi(t)?t?.defaultView??window:t}var Li=class{constructor(t,e){this.#t=e,this.#i=i=>{let n=[];for(let s of i){let o=this.intersections.get(s.target);this.intersections.set(s.target,s),(o?.isIntersecting!==s.isIntersecting||!L.equals(o?.intersectionRect,s.intersectionRect))&&n.push(s)}n.length>0&&t(n,this)}}#i;#e=new Map;#t;intersections=new WeakMap;observe(t){let e=t.ownerDocument;if(!e)return;let i=this.#e.get(e);i||(i=new IntersectionObserver(this.#i,E(C({},this.#t),{threshold:Rt})),this.#e.set(e,i)),i.observe(t)}unobserve(t){let e=t.ownerDocument;if(!e)return;let i=this.#e.get(e);i&&(i.unobserve(t),this.intersections.delete(t))}disconnect(){for(let t of this.#e.values())t.disconnect();this.#e.clear()}},zt=class{constructor(t,e){this.#i=t,this.#e=e,this.#s=new Ti(e?.root,this.#c),this.#o=new Li(this.#d,e),this.#n=new ResizeObserver(this.#p)}#i;#e;#t=new Map;#n;#r=new WeakMap;#s;#o;observe(t){this.#o.observe(t)}unobserve(t){t?(this.#t.get(t)?.disconnect(),this.#o.unobserve(t)):this.disconnect()}disconnect(){for(let t of this.#t.values())t.disconnect();this.#n.disconnect(),this.#s.disconnect(),this.#o.disconnect()}#a(t){let e=[];for(let i of t){let{target:n}=i,s=this.#r.get(n);Di(i,s)||(this.#r.set(n,i),e.push(i))}e.length>0&&this.#i(e)}#c=t=>{let e=[];for(let[i]of this.#t){let n=i.getBoundingClientRect(),s=this.#l(i,n);e.push(new Me(i,n,s.visibleRect,s.isIntersecting,t))}this.#a(e)};#l(t,e){let i=this.#o;this.#t.get(t)?.disconnect();let n=new $i(t,this.#h,{clientRect:e,root:this.#e?.root,rootBounds:this.#s.rootBounds,get clip(){let s=i.intersections.get(t);if(!s)return;let{intersectionRect:o,boundingClientRect:r}=s;return L.clipOffsets(r,o)}});return this.#t.set(t,n),n}#d=t=>{let e=[];for(let i of t){let{target:n,isIntersecting:s,boundingClientRect:o}=i;s?(this.#l(n,o),this.#n.observe(n)):(this.#t.get(n)?.disconnect(),this.#t.delete(n),this.#n.unobserve(n));let r=this.#t.get(n);e.push(new Me(n,o,r?.visibleRect??i.intersectionRect,s,this.#s.rootBounds))}this.#a(e)};#h=(t,e)=>{this.#a([new Me(t.target,t.boundingClientRect,e.visibleRect,t.isIntersecting,this.#s.rootBounds)])};#p=t=>{let e=[];for(let i of t){let{target:n,borderBoxSize:s}=i,o=this.#r.get(n);if(o){let[{inlineSize:l,blockSize:h}]=s;if(L.sizeEqual(o.boundingClientRect,{width:l,height:h}))continue}let r=n.getBoundingClientRect(),c=this.#l(n,r);e.push(new Me(n,r,c.visibleRect,this.#o.intersections.get(n)?.isIntersecting??!1,this.#s.rootBounds))}this.#a(e)}},Me=class{constructor(t,e,i,n,s){this.target=t,this.boundingClientRect=e,this.intersectionRect=i,this.isIntersecting=n,this.rootBounds=s}};function Di(t,e){return e==null?!1:t.target===e.target&&t.isIntersecting===e.isIntersecting&&L.equals(t.boundingClientRect,e.boundingClientRect)&&L.equals(t.intersectionRect,e.intersectionRect)}var Ii=["input:not([inert])","select:not([inert])","textarea:not([inert])","a[href]:not([inert])","button:not([inert])","[tabindex]:not(slot):not([inert])","audio[controls]:not([inert])","video[controls]:not([inert])",'[contenteditable]:not([contenteditable="false"]):not([inert])',"details>summary:first-of-type:not([inert])","details:not([inert])"],Ge=Ii.join(","),Ft=typeof Element>"u",he=Ft?function(){}:Element.prototype.matches||Element.prototype.msMatchesSelector||Element.prototype.webkitMatchesSelector,Oe=!Ft&&Element.prototype.getRootNode?function(t){var e;return t==null||(e=t.getRootNode)===null||e===void 0?void 0:e.call(t)}:function(t){return t?.ownerDocument},Le=function t(e,i){var n;i===void 0&&(i=!0);var s=e==null||(n=e.getAttribute)===null||n===void 0?void 0:n.call(e,"inert"),o=s===""||s==="true",r=o||i&&e&&t(e.parentNode);return r},Ai=function(e){var i,n=e==null||(i=e.getAttribute)===null||i===void 0?void 0:i.call(e,"contenteditable");return n===""||n==="true"},ji=function(e,i,n){if(Le(e))return[];var s=Array.prototype.slice.apply(e.querySelectorAll(Ge));return i&&he.call(e,Ge)&&s.unshift(e),s=s.filter(n),s},Ri=function t(e,i,n){for(var s=[],o=Array.from(e);o.length;){var r=o.shift();if(!Le(r,!1))if(r.tagName==="SLOT"){var c=r.assignedElements(),l=c.length?c:r.children,h=t(l,!0,n);n.flatten?s.push.apply(s,h):s.push({scopeParent:r,candidates:h})}else{var v=he.call(r,Ge);v&&n.filter(r)&&(i||!e.includes(r))&&s.push(r);var y=r.shadowRoot||typeof n.getShadowRoot=="function"&&n.getShadowRoot(r),$=!Le(y,!1)&&(!n.shadowRootFilter||n.shadowRootFilter(r));if(y&&$){var _=t(y===!0?r.children:y.children,!0,n);n.flatten?s.push.apply(s,_):s.push({scopeParent:r,candidates:_})}else o.unshift.apply(o,r.children)}}return s},Bt=function(e){return!isNaN(parseInt(e.getAttribute("tabindex"),10))},Ht=function(e){if(!e)throw new Error("No node provided");return e.tabIndex<0&&(/^(AUDIO|VIDEO|DETAILS)$/.test(e.tagName)||Ai(e))&&!Bt(e)?0:e.tabIndex},Ui=function(e,i){var n=Ht(e);return n<0&&i&&!Bt(e)?0:n},zi=function(e,i){return e.tabIndex===i.tabIndex?e.documentOrder-i.documentOrder:e.tabIndex-i.tabIndex},qt=function(e){return e.tagName==="INPUT"},Vi=function(e){return qt(e)&&e.type==="hidden"},Ni=function(e){var i=e.tagName==="DETAILS"&&Array.prototype.slice.apply(e.children).some(function(n){return n.tagName==="SUMMARY"});return i},Fi=function(e,i){for(var n=0;n<e.length;n++)if(e[n].checked&&e[n].form===i)return e[n]},Bi=function(e){if(!e.name)return!0;var i=e.form||Oe(e),n=function(c){return i.querySelectorAll('input[type="radio"][name="'+c+'"]')},s;if(typeof window<"u"&&typeof window.CSS<"u"&&typeof window.CSS.escape=="function")s=n(window.CSS.escape(e.name));else try{s=n(e.name)}catch(r){return console.error("Looks like you have a radio button with a name attribute containing invalid CSS selector characters and need the CSS.escape polyfill: %s",r.message),!1}var o=Fi(s,e.form);return!o||o===e},Hi=function(e){return qt(e)&&e.type==="radio"},qi=function(e){return Hi(e)&&!Bi(e)},Wi=function(e){var i,n=e&&Oe(e),s=(i=n)===null||i===void 0?void 0:i.host,o=!1;if(n&&n!==e){var r,c,l;for(o=!!((r=s)!==null&&r!==void 0&&(c=r.ownerDocument)!==null&&c!==void 0&&c.contains(s)||e!=null&&(l=e.ownerDocument)!==null&&l!==void 0&&l.contains(e));!o&&s;){var h,v,y;n=Oe(s),s=(h=n)===null||h===void 0?void 0:h.host,o=!!((v=s)!==null&&v!==void 0&&(y=v.ownerDocument)!==null&&y!==void 0&&y.contains(s))}}return o},Vt=function(e){var i=e.getBoundingClientRect(),n=i.width,s=i.height;return n===0&&s===0},Zi=function(e,i){var n=i.displayCheck,s=i.getShadowRoot;if(getComputedStyle(e).visibility==="hidden")return!0;var o=he.call(e,"details>summary:first-of-type"),r=o?e.parentElement:e;if(he.call(r,"details:not([open]) *"))return!0;if(!n||n==="full"||n==="legacy-full"){if(typeof s=="function"){for(var c=e;e;){var l=e.parentElement,h=Oe(e);if(l&&!l.shadowRoot&&s(l)===!0)return Vt(e);e.assignedSlot?e=e.assignedSlot:!l&&h!==e.ownerDocument?e=h.host:e=l}e=c}if(Wi(e))return!e.getClientRects().length;if(n!=="legacy-full")return!0}else if(n==="non-zero-area")return Vt(e);return!1},Gi=function(e){if(/^(INPUT|BUTTON|SELECT|TEXTAREA)$/.test(e.tagName))for(var i=e.parentElement;i;){if(i.tagName==="FIELDSET"&&i.disabled){for(var n=0;n<i.children.length;n++){var s=i.children.item(n);if(s.tagName==="LEGEND")return he.call(i,"fieldset[disabled] *")?!0:!s.contains(e)}return!0}i=i.parentElement}return!1},Ki=function(e,i){return!(i.disabled||Le(i)||Vi(i)||Zi(i,e)||Ni(i)||Gi(i))},Nt=function(e,i){return!(qi(i)||Ht(i)<0||!Ki(e,i))},Yi=function(e){var i=parseInt(e.getAttribute("tabindex"),10);return!!(isNaN(i)||i>=0)},Ji=function t(e){var i=[],n=[];return e.forEach(function(s,o){var r=!!s.scopeParent,c=r?s.scopeParent:s,l=Ui(c,r),h=r?t(s.candidates):c;l===0?r?i.push.apply(i,h):i.push(c):n.push({documentOrder:o,tabIndex:l,item:s,isScope:r,content:h})}),n.sort(zi).reduce(function(s,o){return o.isScope?s.push.apply(s,o.content):s.push(o.content),s},[]).concat(i)},Wt=function(e,i){i=i||{};var n;return i.getShadowRoot?n=Ri([e],i.includeContainer,{filter:Nt.bind(null,i),flatten:!1,getShadowRoot:i.getShadowRoot,shadowRootFilter:Yi}):n=ji(e,i.includeContainer,Nt.bind(null,i)),Ji(n)};var Xi=class{constructor(t){if(this.head=0,this.count=0,t<=0)throw new Error("CircularBuffer capacity must be greater than 0");this.capacity=t,this.buffer=new Array(t)}add(t){this.buffer[this.head]=t,this.head=(this.head+1)%this.capacity,this.count<this.capacity&&this.count++}getFirst(){if(this.count!==0)return this.count<this.capacity?this.buffer[0]:this.buffer[this.head]}getLast(){if(this.count!==0){if(this.count<this.capacity)return this.buffer[this.count-1];{let t=(this.head-1+this.capacity)%this.capacity;return this.buffer[t]}}}getFirstLast(){if(this.count===0)return[void 0,void 0];if(this.count===1){let i=this.count<this.capacity?this.buffer[0]:this.buffer[this.head];return[i,i]}let t=this.getFirst(),e=this.getLast();return[t,e]}resize(t){if(t<=0)throw new Error("CircularBuffer capacity must be greater than 0");if(t===this.capacity)return;let e=this.getAllItems();if(this.capacity=t,this.buffer=new Array(t),this.head=0,this.count=0,e.length>t){let i=e.slice(-t);for(let n of i)this.add(n)}else for(let i of e)this.add(i)}getAllItems(){if(this.count===0)return[];let t=new Array(this.count);if(this.count<this.capacity)for(let e=0;e<this.count;e++)t[e]=this.buffer[e];else{let e=this.head;for(let i=0;i<this.capacity;i++){let n=(e+i)%this.capacity;t[i]=this.buffer[n]}}return t}clear(){this.head=0,this.count=0}get length(){return this.count}get size(){return this.capacity}get isFull(){return this.count===this.capacity}get isEmpty(){return this.count===0}};function ee(t,e,i,n){return t<e?console.warn(`ForesightJS: "${n}" value ${t} is below minimum bound ${e}, clamping to ${e}`):t>i&&console.warn(`ForesightJS: "${n}" value ${t} is above maximum bound ${i}, clamping to ${i}`),Math.min(Math.max(t,e),i)}function Qi(t){let e=window.innerWidth||document.documentElement.clientWidth,i=window.innerHeight||document.documentElement.clientHeight;return t.top<i&&t.bottom>0&&t.left<e&&t.right>0}function Zt(t){if(typeof t=="number"){let e=ee(t,0,2e3,"hitslop");return{top:e,left:e,right:e,bottom:e}}return{top:ee(t.top,0,2e3,"hitslop - top"),left:ee(t.left,0,2e3,"hitslop - left"),right:ee(t.right,0,2e3,"hitslop - right"),bottom:ee(t.bottom,0,2e3,"hitslop - bottom")}}function Ke(t,e){return{left:t.left-e.left,right:t.right+e.right,top:t.top-e.top,bottom:t.bottom+e.bottom}}function Gt(t,e){return!t||!e?t===e:t.left===e.left&&t.right===e.right&&t.top===e.top&&t.bottom===e.bottom}function Xt(t,e){return t.x>=e.left&&t.x<=e.right&&t.y>=e.top&&t.y<=e.bottom}function en(){let t=tn(),e=nn();return{isTouchDevice:t,isLimitedConnection:e,shouldRegister:!t&&!e}}function tn(){return window.matchMedia("(pointer: coarse)").matches&&navigator.maxTouchPoints>0}function nn(){let t=navigator.connection;return t?/2g/.test(t.effectiveType)||t.saveData:!1}function Kt(t,e){return t!==void 0&&e!==t}function Qt(t,e,i){let n=0,s=1,o=e.x-t.x,r=e.y-t.y,c=(l,h)=>{if(l===0){if(h<0)return!1}else{let v=h/l;if(l<0){if(v>s)return!1;v>n&&(n=v)}else{if(v<n)return!1;v<s&&(s=v)}}return!0};return!c(-o,t.x-i.left)||!c(o,i.right-t.x)||!c(-r,t.y-i.top)||!c(r,i.bottom-t.y)?!1:n<=s}function sn(t,e,i){let n=performance.now(),s={point:t,time:n},{x:o,y:r}=t;if(e.add(s),e.length<2)return{x:o,y:r};let[c,l]=e.getFirstLast();if(!c||!l)return{x:o,y:r};let h=(l.time-c.time)*.001;if(h===0)return{x:o,y:r};let v=l.point.x-c.point.x,y=l.point.y-c.point.y,$=v/h,_=y/h,N=i*.001,Si=o+$*N,ki=r+_*N;return{x:Si,y:ki}}var Ye=class{constructor(t){this.elements=t.dependencies.elements,this.callCallback=t.dependencies.callCallback,this.emit=t.dependencies.emit,this.abortController=new AbortController}abort(){this.abortController.abort()}handleError(t,e){console.error(`${this.constructor.name} error in ${e}:`,t)}},on=class extends Ye{constructor(t){super(t),this.pendingMouseEvent=null,this.rafId=null,this.handleMouseMove=e=>{this.pendingMouseEvent=e,!this.rafId&&(this.rafId=requestAnimationFrame(()=>{this.pendingMouseEvent&&this.processMouseMovement(this.pendingMouseEvent),this.rafId=null}))},this.enableMousePrediction=t.settings.enableMousePrediction,this.trajectoryPredictionTime=t.settings.trajectoryPredictionTime,this.positionHistorySize=t.settings.positionHistorySize,this.trajectoryPositions=t.trajectoryPositions,this.initializeListeners()}initializeListeners(){let{signal:t}=this.abortController;document.addEventListener("mousemove",this.handleMouseMove,{signal:t})}updatePointerState(t){let e={x:t.clientX,y:t.clientY};this.trajectoryPositions.currentPoint=e,this.enableMousePrediction?this.trajectoryPositions.predictedPoint=sn(e,this.trajectoryPositions.positions,this.trajectoryPredictionTime):this.trajectoryPositions.predictedPoint=e}cleanup(){this.abort(),this.rafId&&(cancelAnimationFrame(this.rafId),this.rafId=null),this.pendingMouseEvent=null}processMouseMovement(t){try{this.updatePointerState(t);for(let e of this.elements.values()){if(!e.isIntersectingWithViewport)continue;let i=e.elementBounds.expandedRect;if(this.enableMousePrediction)Qt(this.trajectoryPositions.currentPoint,this.trajectoryPositions.predictedPoint,i)&&this.callCallback(e,{kind:"mouse",subType:"trajectory"});else if(Xt(this.trajectoryPositions.currentPoint,i)){this.callCallback(e,{kind:"mouse",subType:"hover"});return}}this.emit({type:"mouseTrajectoryUpdate",predictionEnabled:this.enableMousePrediction,trajectoryPositions:this.trajectoryPositions})}catch(e){this.handleError(e,"processMouseMovement")}}};function rn(t,e){let i=e.top-t.top,n=e.left-t.left;return i<-1?"down":i>1?"up":n<-1?"right":n>1?"left":"none"}function an(t,e,i){let{x:n,y:s}=t,o={x:n,y:s};switch(e){case"down":o.y+=i;break;case"up":o.y-=i;break;case"left":o.x-=i;break;case"right":o.x+=i;break;case"none":break;default:}return o}var Yt=class extends Ye{constructor(t){super(t),this.predictedScrollPoint=null,this.scrollDirection=null,this.scrollMargin=t.settings.scrollMargin,this.trajectoryPositions=t.trajectoryPositions}initializeListeners(){}cleanup(){this.abort(),this.resetScrollProps()}resetScrollProps(){this.scrollDirection=null,this.predictedScrollPoint=null}handleScrollPrefetch(t,e){if(t.isIntersectingWithViewport)try{if(this.scrollDirection=this.scrollDirection??rn(t.elementBounds.originalRect,e),this.scrollDirection==="none")return;this.predictedScrollPoint=this.predictedScrollPoint??an(this.trajectoryPositions.currentPoint,this.scrollDirection,this.scrollMargin),Qt(this.trajectoryPositions.currentPoint,this.predictedScrollPoint,t.elementBounds.expandedRect)&&this.callCallback(t,{kind:"scroll",subType:this.scrollDirection}),this.emit({type:"scrollTrajectoryUpdate",currentPoint:this.trajectoryPositions.currentPoint,predictedPoint:this.predictedScrollPoint,scrollDirection:this.scrollDirection})}catch(i){this.handleError(i,"handleScrollPrefetch")}}handleError(t,e){super.handleError(t,e),this.emit({type:"scrollTrajectoryUpdate",currentPoint:this.trajectoryPositions.currentPoint,predictedPoint:this.trajectoryPositions.currentPoint,scrollDirection:"none"})}};function ln(t,e,i,n){if(e!==null&&e>-1){let s=t?e-1:e+1;if(s>=0&&s<i.length&&i[s]===n)return s}return i.findIndex(s=>s===n)}var Jt=class extends Ye{constructor(t){super(t),this.lastKeyDown=null,this.tabbableElementsCache=[],this.lastFocusedIndex=null,this.handleKeyDown=e=>{e.key==="Tab"&&(this.lastKeyDown=e)},this.handleFocusIn=e=>{try{if(!this.lastKeyDown)return;let i=e.target;if(!(i instanceof HTMLElement))return;(!this.tabbableElementsCache.length||this.lastFocusedIndex===-1)&&(this.tabbableElementsCache=Wt(document.documentElement));let n=this.lastKeyDown.shiftKey,s=ln(n,this.lastFocusedIndex,this.tabbableElementsCache,i);this.lastFocusedIndex=s,this.lastKeyDown=null;let o=[];for(let r=0;r<=this.tabOffset;r++){let c=n?s-r:s+r,l=this.tabbableElementsCache[c];l&&l instanceof Element&&this.elements.has(l)&&o.push(l)}o.forEach(r=>{let c=this.elements.get(r);c&&this.callCallback(c,{kind:"tab",subType:n?"reverse":"forwards"})})}catch(i){this.handleError(i,"handleFocusIn")}},this.tabOffset=t.settings.tabOffset,this.initializeListeners()}initializeListeners(){let{signal:t}=this.abortController;document.addEventListener("keydown",this.handleKeyDown,{signal:t}),document.addEventListener("focusin",this.handleFocusIn,{signal:t})}invalidateCache(){this.tabbableElementsCache=[],this.lastFocusedIndex=null}cleanup(){this.abort(),this.tabbableElementsCache=[],this.lastFocusedIndex=null,this.lastKeyDown=null}},f=class te{constructor(){this.elements=new Map,this.trajectoryPositions={positions:new Xi(8),currentPoint:{x:0,y:0},predictedPoint:{x:0,y:0}},this.isSetup=!1,this._globalCallbackHits={mouse:{hover:0,trajectory:0},tab:{forwards:0,reverse:0},scroll:{down:0,left:0,right:0,up:0},total:0},this._globalSettings={debug:!1,enableMousePrediction:!0,enableScrollPrediction:!0,positionHistorySize:8,trajectoryPredictionTime:120,scrollMargin:150,defaultHitSlop:{top:0,left:0,right:0,bottom:0},enableTabPrediction:!0,tabOffset:2},this.domObserver=null,this.positionObserver=null,this.eventListeners=new Map,this.mousePredictor=null,this.tabPredictor=null,this.scrollPredictor=null,this.handleDomMutations=e=>{e.length&&this.tabPredictor?.invalidateCache();for(let i of e)if(i.type==="childList"&&i.removedNodes.length>0)for(let n of this.elements.keys())n.isConnected||this.unregister(n,"disconnected")},this.handlePositionChange=e=>{for(let i of e){let n=this.elements.get(i.target);n&&(this._globalSettings.enableScrollPrediction?this.scrollPredictor?.handleScrollPrefetch(n,i.boundingClientRect):Xt(this.trajectoryPositions.currentPoint,n.elementBounds.expandedRect)&&this.callCallback(n,{kind:"mouse",subType:"hover"}),this.handlePositionChangeDataUpdates(n,i))}this._globalSettings.enableScrollPrediction&&this.scrollPredictor?.resetScrollProps()},this.handlePositionChangeDataUpdates=(e,i)=>{let n=[],s=i.isIntersecting;e.isIntersectingWithViewport!==s&&(n.push("visibility"),e.isIntersectingWithViewport=s),s&&(n.push("bounds"),e.elementBounds={hitSlop:e.elementBounds.hitSlop,originalRect:i.boundingClientRect,expandedRect:Ke(i.boundingClientRect,e.elementBounds.hitSlop)}),n.length&&this.emit({type:"elementDataUpdated",elementData:e,updatedProps:n})}}static initialize(e){return this.isInitiated||(te.manager=new te),e!==void 0&&te.manager.alterGlobalSettings(e),te.manager}addEventListener(e,i,n){if(n?.signal?.aborted)return()=>{};let s=this.eventListeners.get(e)??[];s.push(i),this.eventListeners.set(e,s),n?.signal?.addEventListener("abort",()=>this.removeEventListener(e,i))}removeEventListener(e,i){let n=this.eventListeners.get(e);if(!n)return;let s=n.indexOf(i);s>-1&&n.splice(s,1)}emit(e){let i=this.eventListeners.get(e.type);i&&i.forEach((n,s)=>{try{n(e)}catch(o){console.error(`Error in ForesightManager event listener ${s} for ${e.type}:`,o)}})}get getManagerData(){return{registeredElements:this.elements,globalSettings:this._globalSettings,globalCallbackHits:this._globalCallbackHits,eventListeners:this.eventListeners,historyPositions:this.trajectoryPositions}}static get isInitiated(){return!!te.manager}static get instance(){return this.initialize()}get registeredElements(){return this.elements}register({element:e,callback:i,hitSlop:n,name:s}){let{shouldRegister:o,isTouchDevice:r,isLimitedConnection:c}=en();if(!o)return{isLimitedConnection:c,isTouchDevice:r,isRegistered:!1,unregister:()=>{}};this.isSetup||this.initializeGlobalListeners();let l=e.getBoundingClientRect(),h=n?Zt(n):this._globalSettings.defaultHitSlop,v={element:e,callback:i,elementBounds:{originalRect:l,expandedRect:Ke(l,h),hitSlop:h},isHovering:!1,trajectoryHitData:{isTrajectoryHit:!1,trajectoryHitTime:0,trajectoryHitExpirationTimeoutId:void 0},name:s||e.id||"unnamed",isIntersectingWithViewport:Qi(l),isRunningCallback:!1,registerCount:(this.registeredElements.get(e)?.registerCount??0)+1};return this.elements.set(e,v),this.positionObserver?.observe(e),this.emit({type:"elementRegistered",timestamp:Date.now(),elementData:v}),{isTouchDevice:r,isLimitedConnection:c,isRegistered:!0,unregister:()=>this.unregister(e,"apiCall")}}unregister(e,i){if(!this.elements.has(e))return;let n=this.elements.get(e);n?.trajectoryHitData.trajectoryHitExpirationTimeoutId&&clearTimeout(n.trajectoryHitData.trajectoryHitExpirationTimeoutId),this.positionObserver?.unobserve(e),this.elements.delete(e);let s=this.elements.size===0&&this.isSetup;s&&this.removeGlobalListeners(),n&&this.emit({type:"elementUnregistered",elementData:n,timestamp:Date.now(),unregisterReason:i,wasLastElement:s})}updateNumericSettings(e,i,n,s){return Kt(e,this._globalSettings[i])?(this._globalSettings[i]=ee(e,n,s,i),!0):!1}updateBooleanSetting(e,i){return Kt(e,this._globalSettings[i])?(this._globalSettings[i]=e,!0):!1}alterGlobalSettings(e){let i=[],n=this._globalSettings.trajectoryPredictionTime;this.updateNumericSettings(e?.trajectoryPredictionTime,"trajectoryPredictionTime",10,200)&&i.push({setting:"trajectoryPredictionTime",oldValue:n,newValue:this._globalSettings.trajectoryPredictionTime});let s=this._globalSettings.positionHistorySize;this.updateNumericSettings(e?.positionHistorySize,"positionHistorySize",2,30)&&(i.push({setting:"positionHistorySize",oldValue:s,newValue:this._globalSettings.positionHistorySize}),this.trajectoryPositions.positions.resize(this._globalSettings.positionHistorySize));let o=this._globalSettings.scrollMargin;if(this.updateNumericSettings(e?.scrollMargin,"scrollMargin",30,300)){let v=this._globalSettings.scrollMargin;this.scrollPredictor&&(this.scrollPredictor.scrollMargin=v),i.push({setting:"scrollMargin",oldValue:o,newValue:v})}let r=this._globalSettings.tabOffset;this.updateNumericSettings(e?.tabOffset,"tabOffset",0,20)&&(this.tabPredictor&&(this.tabPredictor.tabOffset=this._globalSettings.tabOffset),i.push({setting:"tabOffset",oldValue:r,newValue:this._globalSettings.tabOffset}));let c=this._globalSettings.enableMousePrediction;this.updateBooleanSetting(e?.enableMousePrediction,"enableMousePrediction")&&i.push({setting:"enableMousePrediction",oldValue:c,newValue:this._globalSettings.enableMousePrediction});let l=this._globalSettings.enableScrollPrediction;this.updateBooleanSetting(e?.enableScrollPrediction,"enableScrollPrediction")&&(this._globalSettings.enableScrollPrediction?this.scrollPredictor=new Yt({dependencies:{callCallback:this.callCallback.bind(this),emit:this.emit.bind(this),elements:this.elements},settings:{scrollMargin:this._globalSettings.scrollMargin},trajectoryPositions:this.trajectoryPositions}):(this.scrollPredictor?.cleanup(),this.scrollPredictor=null),i.push({setting:"enableScrollPrediction",oldValue:l,newValue:this._globalSettings.enableScrollPrediction}));let h=this._globalSettings.enableTabPrediction;if(this.updateBooleanSetting(e?.enableTabPrediction,"enableTabPrediction")&&(i.push({setting:"enableTabPrediction",oldValue:h,newValue:this._globalSettings.enableTabPrediction}),this._globalSettings.enableTabPrediction?this.tabPredictor=new Jt({dependencies:{callCallback:this.callCallback.bind(this),emit:this.emit.bind(this),elements:this.elements},settings:{tabOffset:this._globalSettings.tabOffset}}):(this.tabPredictor?.cleanup(),this.tabPredictor=null)),e?.defaultHitSlop!==void 0){let v=this._globalSettings.defaultHitSlop,y=Zt(e.defaultHitSlop);Gt(v,y)||(this._globalSettings.defaultHitSlop=y,i.push({setting:"defaultHitSlop",oldValue:v,newValue:y}),this.forceUpdateAllElementBounds())}i.length>0&&this.emit({type:"managerSettingsChanged",timestamp:Date.now(),managerData:this.getManagerData,updatedSettings:i})}updateHitCounters(e){switch(e.kind){case"mouse":this._globalCallbackHits.mouse[e.subType]++;break;case"tab":this._globalCallbackHits.tab[e.subType]++;break;case"scroll":this._globalCallbackHits.scroll[e.subType]++;break;default:}this._globalCallbackHits.total++}callCallback(e,i){if(e.isRunningCallback)return;let n=()=>I(this,null,function*(){this.updateHitCounters(i),this.emit({type:"callbackInvoked",timestamp:Date.now(),elementData:e,hitType:i});let s=performance.now();try{yield e.callback(),this.emit({type:"callbackCompleted",timestamp:Date.now(),elementData:e,hitType:i,elapsed:performance.now()-s,status:"success"})}catch(o){let r=o instanceof Error?o.message:String(o);console.error(`Error in callback for element ${e.name} (${e.element.tagName}):`,o),this.emit({type:"callbackCompleted",timestamp:Date.now(),elementData:e,hitType:i,elapsed:performance.now()-s,status:"error",errorMessage:r})}this.unregister(e.element,"callbackHit")});e.isRunningCallback=!0,n()}initializeGlobalListeners(){if(this.isSetup||typeof window>"u"||typeof document>"u")return;let e=this._globalSettings,i={callCallback:this.callCallback.bind(this),emit:this.emit.bind(this),elements:this.elements};e.enableTabPrediction&&(this.tabPredictor=new Jt({dependencies:i,settings:{tabOffset:e.tabOffset}})),e.enableScrollPrediction&&(this.scrollPredictor=new Yt({dependencies:i,settings:{scrollMargin:e.scrollMargin},trajectoryPositions:this.trajectoryPositions})),this.mousePredictor=new on({dependencies:i,settings:{enableMousePrediction:e.enableMousePrediction,trajectoryPredictionTime:e.trajectoryPredictionTime,positionHistorySize:e.positionHistorySize},trajectoryPositions:this.trajectoryPositions}),this.domObserver=new MutationObserver(this.handleDomMutations),this.domObserver.observe(document.documentElement,{childList:!0,subtree:!0,attributes:!1}),this.positionObserver=new zt(this.handlePositionChange),this.isSetup=!0}removeGlobalListeners(){this.isSetup=!1,this.domObserver?.disconnect(),this.domObserver=null,this.positionObserver?.disconnect(),this.positionObserver=null,this.mousePredictor?.cleanup(),this.tabPredictor?.cleanup(),this.scrollPredictor?.cleanup()}forceUpdateAllElementBounds(){for(let[,e]of this.elements)e.isIntersectingWithViewport&&this.forceUpdateElementBounds(e)}forceUpdateElementBounds(e){let i=e.element.getBoundingClientRect(),n=Ke(i,e.elementBounds.hitSlop);if(!Gt(n,e.elementBounds.expandedRect)){let s=E(C({},e),{elementBounds:E(C({},e.elementBounds),{originalRect:i,expandedRect:n})});this.elements.set(e.element,s),this.emit({type:"elementDataUpdated",elementData:s,updatedProps:["bounds"]})}}};var hn=[],ei=(()=>{class t{router;trees=hn;constructor(i){this.router=i}add(i){this.trees.push(i)}shouldPrefetch(i){let n=this.router.parseUrl(i);return this.trees.some(gn.bind(null,n))}static \u0275fac=function(n){return new(n||t)($e(ce))};static \u0275prov=Ze({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();function pn(t,e){return Object.keys(e).length<=Object.keys(t).length&&Object.keys(e).every(i=>e[i]===t[i])}function gn(t,e){return pn(e.queryParams,t.queryParams)&&Xe(e.root,t.root,t.root.segments)}function Xe(t,e,i){if(t.segments.length>i.length){let n=t.segments.slice(0,i.length);return!(!Je(n,i)||e.hasChildren())}else if(t.segments.length===i.length){if(!Je(t.segments,i))return!1;if(!e.hasChildren())return!0;for(let n in e.children){if(!t.children[n])break;if(Xe(t.children[n],e.children[n],e.children[n].segments))return!0}return!1}else{let n=i.slice(0,t.segments.length),s=i.slice(t.segments.length);return!Je(t.segments,n)||!t.children[Pe]?!1:Xe(t.children[Pe],e,s)}}function Je(t,e){return t.length!==e.length?!1:t.every((i,n)=>i.path===e[n].path||i.path.startsWith(":")||e[n].path.startsWith(":"))}var ti=(()=>{class t{elementRef;router=_e(ce);registry=_e(ei);preloader=_e(Mt);routerLink="";href="";name=void 0;unregisterRef=()=>{};constructor(i){this.elementRef=i}ngOnInit(){let{unregister:i}=f.instance.register({element:this.elementRef.nativeElement,name:this.name,callback:()=>{if(!this.routerLink&&!this.href)return;let n=this.router.parseUrl(this.routerLink||this.href);this.registry.add(n),this.preloader.preload().subscribe(()=>{})}});this.unregisterRef=i}ngOnDestroy(){this.unregisterRef()}static \u0275fac=function(n){return new(n||t)(vt(bt))};static \u0275dir=mt({type:t,selectors:[["","foresightjs",""],["","registerForesight",""]],inputs:{routerLink:"routerLink",href:"href",name:[0,"registerForesight","name"]},standalone:!0})}return t})(),un=(t,e)=>{t=t.slice();let i=new Map,n=new Set;for(;t.length;){let r=t.shift();if(!r)continue;if(n.add(r),r===e)break;let c=r.children||[],l=r._loadedRoutes||[];for(let h of l)h&&h.children&&(c=c.concat(h.children));c.forEach(h=>{n.has(h)||(i.set(h,r),t.push(h))})}let s="",o=e;for(;o;)mn(o)?s=`/${o.path}${s}`:s=`/(${o.outlet}:${o.path}${s})`,o=i.get(o);return s.replace(/[\/]+/,"/")};function mn(t){return t.outlet===Pe||!t.outlet}var ii=(()=>{class t{registry;router;loading=new Set;constructor(i,n){this.registry=i,this.router=n}preload(i,n){if(this.loading.has(i))return Ee;if(i.data&&i.data.preload===!1)return Ee;let s=un(this.router.config,i);return this.registry.shouldPrefetch(s)?(this.loading.add(i),n()):Ee}static \u0275fac=function(n){return new(n||t)($e(ei),$e(ce))};static \u0275prov=Ze({token:t,factory:t.\u0275fac,providedIn:"root"})}return t})();var ni={providers:[$t({eventCoalescing:!0}),Ot(It,Lt(ii))]};var De=globalThis,Ie=De.ShadowRoot&&(De.ShadyCSS===void 0||De.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Qe=Symbol(),si=new WeakMap,pe=class{constructor(e,i,n){if(this._$cssResult$=!0,n!==Qe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o,i=this.t;if(Ie&&e===void 0){let n=i!==void 0&&i.length===1;n&&(e=si.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),n&&si.set(i,e))}return e}toString(){return this.cssText}},oi=t=>new pe(typeof t=="string"?t:t+"",void 0,Qe),m=(t,...e)=>{let i=t.length===1?t[0]:e.reduce((n,s,o)=>n+(r=>{if(r._$cssResult$===!0)return r.cssText;if(typeof r=="number")return r;throw Error("Value passed to 'css' function must be a 'css' function result: "+r+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+t[o+1],t[0]);return new pe(i,t,Qe)},ri=(t,e)=>{if(Ie)t.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(let i of e){let n=document.createElement("style"),s=De.litNonce;s!==void 0&&n.setAttribute("nonce",s),n.textContent=i.cssText,t.appendChild(n)}},et=Ie?t=>t:t=>t instanceof CSSStyleSheet?(e=>{let i="";for(let n of e.cssRules)i+=n.cssText;return oi(i)})(t):t;var{is:bn,defineProperty:fn,getOwnPropertyDescriptor:vn,getOwnPropertyNames:yn,getOwnPropertySymbols:wn,getPrototypeOf:xn}=Object,Ae=globalThis,ai=Ae.trustedTypes,Cn=ai?ai.emptyScript:"",Sn=Ae.reactiveElementPolyfillSupport,ge=(t,e)=>t,ue={toAttribute(t,e){switch(e){case Boolean:t=t?Cn:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t)}return t},fromAttribute(t,e){let i=t;switch(e){case Boolean:i=t!==null;break;case Number:i=t===null?null:Number(t);break;case Object:case Array:try{i=JSON.parse(t)}catch{i=null}}return i}},je=(t,e)=>!bn(t,e),li={attribute:!0,type:String,converter:ue,reflect:!1,useDefault:!1,hasChanged:je};Symbol.metadata??=Symbol("metadata"),Ae.litPropertyMetadata??=new WeakMap;var A=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=li){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){let n=Symbol(),s=this.getPropertyDescriptor(e,n,i);s!==void 0&&fn(this.prototype,e,s)}}static getPropertyDescriptor(e,i,n){let{get:s,set:o}=vn(this.prototype,e)??{get(){return this[i]},set(r){this[i]=r}};return{get:s,set(r){let c=s?.call(this);o?.call(this,r),this.requestUpdate(e,c,n)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??li}static _$Ei(){if(this.hasOwnProperty(ge("elementProperties")))return;let e=xn(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(ge("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(ge("properties"))){let i=this.properties,n=[...yn(i),...wn(i)];for(let s of n)this.createProperty(s,i[s])}let e=this[Symbol.metadata];if(e!==null){let i=litPropertyMetadata.get(e);if(i!==void 0)for(let[n,s]of i)this.elementProperties.set(n,s)}this._$Eh=new Map;for(let[i,n]of this.elementProperties){let s=this._$Eu(i,n);s!==void 0&&this._$Eh.set(s,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let i=[];if(Array.isArray(e)){let n=new Set(e.flat(1/0).reverse());for(let s of n)i.unshift(et(s))}else e!==void 0&&i.push(et(e));return i}static _$Eu(e,i){let n=i.attribute;return n===!1?void 0:typeof n=="string"?n:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,i=this.constructor.elementProperties;for(let n of i.keys())this.hasOwnProperty(n)&&(e.set(n,this[n]),delete this[n]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ri(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,i,n){this._$AK(e,n)}_$ET(e,i){let n=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,n);if(s!==void 0&&n.reflect===!0){let o=(n.converter?.toAttribute!==void 0?n.converter:ue).toAttribute(i,n.type);this._$Em=e,o==null?this.removeAttribute(s):this.setAttribute(s,o),this._$Em=null}}_$AK(e,i){let n=this.constructor,s=n._$Eh.get(e);if(s!==void 0&&this._$Em!==s){let o=n.getPropertyOptions(s),r=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:ue;this._$Em=s;let c=r.fromAttribute(i,o.type);this[s]=c??this._$Ej?.get(s)??c,this._$Em=null}}requestUpdate(e,i,n){if(e!==void 0){let s=this.constructor,o=this[e];if(n??=s.getPropertyOptions(e),!((n.hasChanged??je)(o,i)||n.useDefault&&n.reflect&&o===this._$Ej?.get(e)&&!this.hasAttribute(s._$Eu(e,n))))return;this.C(e,i,n)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:n,reflect:s,wrapped:o},r){n&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,r??i??this[e]),o!==!0||r!==void 0)||(this._$AL.has(e)||(this.hasUpdated||n||(i=void 0),this._$AL.set(e,i)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}_$EP(){return I(this,null,function*(){this.isUpdatePending=!0;try{yield this._$ES}catch(i){Promise.reject(i)}let e=this.scheduleUpdate();return e!=null&&(yield e),!this.isUpdatePending})}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,o]of this._$Ep)this[s]=o;this._$Ep=void 0}let n=this.constructor.elementProperties;if(n.size>0)for(let[s,o]of n){let{wrapped:r}=o,c=this[s];r!==!0||this._$AL.has(s)||c===void 0||this.C(s,void 0,o,c)}}let e=!1,i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),this._$EO?.forEach(n=>n.hostUpdate?.()),this.update(i)):this._$EM()}catch(n){throw e=!1,this._$EM(),n}e&&this._$AE(i)}willUpdate(e){}_$AE(e){this._$EO?.forEach(i=>i.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(i=>this._$ET(i,this[i])),this._$EM()}updated(e){}firstUpdated(e){}};A.elementStyles=[],A.shadowRootOptions={mode:"open"},A[ge("elementProperties")]=new Map,A[ge("finalized")]=new Map,Sn?.({ReactiveElement:A}),(Ae.reactiveElementVersions??=[]).push("2.1.1");var at=globalThis,Re=at.trustedTypes,ci=Re?Re.createPolicy("lit-html",{createHTML:t=>t}):void 0,mi="$lit$",U=`lit$${Math.random().toFixed(9).slice(2)}$`,bi="?"+U,kn=`<${bi}>`,q=document,be=()=>q.createComment(""),fe=t=>t===null||typeof t!="object"&&typeof t!="function",lt=Array.isArray,En=t=>lt(t)||typeof t?.[Symbol.iterator]=="function",tt=`[ 	
\f\r]`,me=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,di=/-->/g,hi=/>/g,B=RegExp(`>|${tt}(?:([^\\s"'>=/]+)(${tt}*=${tt}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),pi=/'/g,gi=/"/g,fi=/^(?:script|style|textarea|title)$/i,ct=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),d=ct(1),Ws=ct(2),Zs=ct(3),M=Symbol.for("lit-noChange"),S=Symbol.for("lit-nothing"),ui=new WeakMap,H=q.createTreeWalker(q,129);function vi(t,e){if(!lt(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return ci!==void 0?ci.createHTML(e):e}var $n=(t,e)=>{let i=t.length-1,n=[],s,o=e===2?"<svg>":e===3?"<math>":"",r=me;for(let c=0;c<i;c++){let l=t[c],h,v,y=-1,$=0;for(;$<l.length&&(r.lastIndex=$,v=r.exec(l),v!==null);)$=r.lastIndex,r===me?v[1]==="!--"?r=di:v[1]!==void 0?r=hi:v[2]!==void 0?(fi.test(v[2])&&(s=RegExp("</"+v[2],"g")),r=B):v[3]!==void 0&&(r=B):r===B?v[0]===">"?(r=s??me,y=-1):v[1]===void 0?y=-2:(y=r.lastIndex-v[2].length,h=v[1],r=v[3]===void 0?B:v[3]==='"'?gi:pi):r===gi||r===pi?r=B:r===di||r===hi?r=me:(r=B,s=void 0);let _=r===B&&t[c+1].startsWith("/>")?" ":"";o+=r===me?l+kn:y>=0?(n.push(h),l.slice(0,y)+mi+l.slice(y)+U+_):l+U+(y===-2?c:_)}return[vi(t,o+(t[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),n]},ve=class t{constructor({strings:e,_$litType$:i},n){let s;this.parts=[];let o=0,r=0,c=e.length-1,l=this.parts,[h,v]=$n(e,i);if(this.el=t.createElement(h,n),H.currentNode=this.el.content,i===2||i===3){let y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(s=H.nextNode())!==null&&l.length<c;){if(s.nodeType===1){if(s.hasAttributes())for(let y of s.getAttributeNames())if(y.endsWith(mi)){let $=v[r++],_=s.getAttribute(y).split(U),N=/([.?@])?(.*)/.exec($);l.push({type:1,index:o,name:N[2],strings:_,ctor:N[1]==="."?nt:N[1]==="?"?st:N[1]==="@"?ot:ne}),s.removeAttribute(y)}else y.startsWith(U)&&(l.push({type:6,index:o}),s.removeAttribute(y));if(fi.test(s.tagName)){let y=s.textContent.split(U),$=y.length-1;if($>0){s.textContent=Re?Re.emptyScript:"";for(let _=0;_<$;_++)s.append(y[_],be()),H.nextNode(),l.push({type:2,index:++o});s.append(y[$],be())}}}else if(s.nodeType===8)if(s.data===bi)l.push({type:2,index:o});else{let y=-1;for(;(y=s.data.indexOf(U,y+1))!==-1;)l.push({type:7,index:o}),y+=U.length-1}o++}}static createElement(e,i){let n=q.createElement("template");return n.innerHTML=e,n}};function ie(t,e,i=t,n){if(e===M)return e;let s=n!==void 0?i._$Co?.[n]:i._$Cl,o=fe(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(t),s._$AT(t,i,n)),n!==void 0?(i._$Co??=[])[n]=s:i._$Cl=s),s!==void 0&&(e=ie(t,s._$AS(t,e.values),s,n)),e}var it=class{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:i},parts:n}=this._$AD,s=(e?.creationScope??q).importNode(i,!0);H.currentNode=s;let o=H.nextNode(),r=0,c=0,l=n[0];for(;l!==void 0;){if(r===l.index){let h;l.type===2?h=new ye(o,o.nextSibling,this,e):l.type===1?h=new l.ctor(o,l.name,l.strings,this,e):l.type===6&&(h=new rt(o,this,e)),this._$AV.push(h),l=n[++c]}r!==l?.index&&(o=H.nextNode(),r++)}return H.currentNode=q,s}p(e){let i=0;for(let n of this._$AV)n!==void 0&&(n.strings!==void 0?(n._$AI(e,n,i),i+=n.strings.length-2):n._$AI(e[i])),i++}},ye=class t{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,i,n,s){this.type=2,this._$AH=S,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=n,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,i=this._$AM;return i!==void 0&&e?.nodeType===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=ie(this,e,i),fe(e)?e===S||e==null||e===""?(this._$AH!==S&&this._$AR(),this._$AH=S):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):En(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==S&&fe(this._$AH)?this._$AA.nextSibling.data=e:this.T(q.createTextNode(e)),this._$AH=e}$(e){let{values:i,_$litType$:n}=e,s=typeof n=="number"?this._$AC(e):(n.el===void 0&&(n.el=ve.createElement(vi(n.h,n.h[0]),this.options)),n);if(this._$AH?._$AD===s)this._$AH.p(i);else{let o=new it(s,this),r=o.u(this.options);o.p(i),this.T(r),this._$AH=o}}_$AC(e){let i=ui.get(e.strings);return i===void 0&&ui.set(e.strings,i=new ve(e)),i}k(e){lt(this._$AH)||(this._$AH=[],this._$AR());let i=this._$AH,n,s=0;for(let o of e)s===i.length?i.push(n=new t(this.O(be()),this.O(be()),this,this.options)):n=i[s],n._$AI(o),s++;s<i.length&&(this._$AR(n&&n._$AB.nextSibling,s),i.length=s)}_$AR(e=this._$AA.nextSibling,i){for(this._$AP?.(!1,!0,i);e!==this._$AB;){let n=e.nextSibling;e.remove(),e=n}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},ne=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,n,s,o){this.type=1,this._$AH=S,this._$AN=void 0,this.element=e,this.name=i,this._$AM=s,this.options=o,n.length>2||n[0]!==""||n[1]!==""?(this._$AH=Array(n.length-1).fill(new String),this.strings=n):this._$AH=S}_$AI(e,i=this,n,s){let o=this.strings,r=!1;if(o===void 0)e=ie(this,e,i,0),r=!fe(e)||e!==this._$AH&&e!==M,r&&(this._$AH=e);else{let c=e,l,h;for(e=o[0],l=0;l<o.length-1;l++)h=ie(this,c[n+l],i,l),h===M&&(h=this._$AH[l]),r||=!fe(h)||h!==this._$AH[l],h===S?e=S:e!==S&&(e+=(h??"")+o[l+1]),this._$AH[l]=h}r&&!s&&this.j(e)}j(e){e===S?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},nt=class extends ne{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===S?void 0:e}},st=class extends ne{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==S)}},ot=class extends ne{constructor(e,i,n,s,o){super(e,i,n,s,o),this.type=5}_$AI(e,i=this){if((e=ie(this,e,i,0)??S)===M)return;let n=this._$AH,s=e===S&&n!==S||e.capture!==n.capture||e.once!==n.once||e.passive!==n.passive,o=e!==S&&(n===S||s);s&&this.element.removeEventListener(this.name,this,n),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},rt=class{constructor(e,i,n){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=n}get _$AU(){return this._$AM._$AU}_$AI(e){ie(this,e)}};var _n=at.litHtmlPolyfillSupport;_n?.(ve,ye),(at.litHtmlVersions??=[]).push("3.3.1");var yi=(t,e,i)=>{let n=i?.renderBefore??e,s=n._$litPart$;if(s===void 0){let o=i?.renderBefore??null;n._$litPart$=s=new ye(e.insertBefore(be(),o),o,void 0,i??{})}return s._$AI(t),s};var dt=globalThis,g=class extends A{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=yi(i,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};g._$litElement$=!0,g.finalized=!0,dt.litElementHydrateSupport?.({LitElement:g});var Tn=dt.litElementPolyfillSupport;Tn?.({LitElement:g});(dt.litElementVersions??=[]).push("4.2.1");var b=t=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(t,e)}):customElements.define(t,e)};var Pn={attribute:!0,type:String,converter:ue,reflect:!1,hasChanged:je},Mn=(t=Pn,e,i)=>{let{kind:n,metadata:s}=i,o=globalThis.litPropertyMetadata.get(s);if(o===void 0&&globalThis.litPropertyMetadata.set(s,o=new Map),n==="setter"&&((t=Object.create(t)).wrapped=!0),o.set(i.name,t),n==="accessor"){let{name:r}=i;return{set(c){let l=e.get.call(this);e.set.call(this,c),this.requestUpdate(r,l,t)},init(c){return c!==void 0&&this.C(r,void 0,t,c),c}}}if(n==="setter"){let{name:r}=i;return function(c){let l=this[r];e.call(this,c),this.requestUpdate(r,l,t)}}throw Error("Unsupported decorator location: "+n)};function p(t){return(e,i)=>typeof i=="object"?Mn(t,e,i):((n,s,o)=>{let r=s.hasOwnProperty(o);return s.constructor.createProperty(o,n),r?Object.getOwnPropertyDescriptor(s,o):void 0})(t,e,i)}function u(t){return p(E(C({},t),{state:!0,attribute:!1}))}var W=(t,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(t,e,i),i);function wi(t,e){return(i,n,s)=>{let o=r=>r.renderRoot?.querySelector(t)??null;if(e){let{get:r,set:c}=typeof n=="object"?i:s??(()=>{let l=Symbol();return{get(){return this[l]},set(h){this[l]=h}}})();return W(i,n,{get(){let l=r.call(this);return l===void 0&&(l=o(this),(l!==null||this.hasUpdated)&&c.call(this,l)),l}})}return W(i,n,{get(){return o(this)}})}}var Ue={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},ze=t=>(...e)=>({_$litDirective$:t,values:e}),se=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,i,n){this._$Ct=e,this._$AM=i,this._$Ci=n}_$AS(e,i){return this.update(e,i)}update(e,i){return this.render(...i)}};var Ve=ze(class extends se{constructor(t){if(super(t),t.type!==Ue.ATTRIBUTE||t.name!=="class"||t.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(t){return" "+Object.keys(t).filter(e=>t[e]).join(" ")+" "}update(t,[e]){if(this.st===void 0){this.st=new Set,t.strings!==void 0&&(this.nt=new Set(t.strings.join(" ").split(/\s/).filter(n=>n!=="")));for(let n in e)e[n]&&!this.nt?.has(n)&&this.st.add(n);return this.render(e)}let i=t.element.classList;for(let n of this.st)n in e||(i.remove(n),this.st.delete(n));for(let n in e){let s=!!e[n];s===this.st.has(n)||this.nt?.has(n)||(s?(i.add(n),this.st.add(n)):(i.remove(n),this.st.delete(n)))}return M}});function*Ne(t,e){if(t!==void 0){let i=0;for(let n of t)yield e(n,i++)}}var xi="important",On=" !"+xi,Fe=ze(class extends se{constructor(t){if(super(t),t.type!==Ue.ATTRIBUTE||t.name!=="style"||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{let n=t[i];return n==null?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${n};`},"")}update(t,[e]){let{style:i}=t.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(e)),this.render(e);for(let n of this.ft)e[n]==null&&(this.ft.delete(n),n.includes("-")?i.removeProperty(n):i[n]=null);for(let n in e){let s=e[n];if(s!=null){this.ft.add(n);let o=typeof s=="string"&&s.endsWith(On);n.includes("-")||o?i.setProperty(n,o?s.slice(0,-11):s,o?xi:""):i[n]=s}}return M}});var Ln=Object.defineProperty,Dn=Object.getOwnPropertyDescriptor,a=(t,e,i,n)=>{for(var s=n>1?void 0:n?Dn(e,i):e,o=t.length-1,r;o>=0;o--)(r=t[o])&&(s=(n?r(e,i,s):r(s))||s);return n&&s&&Ln(e,i,s),s},ht=class extends g{render(){return d`
    ...
    `],a([u()],Se.prototype,"isDropdownOpen",2),a([p({type:Array})],Se.prototype,"dropdownOptions",2);var gt=Se,Be=class extends gt{constructor(){super(...arguments),this.selectedOptionValue=""}connectedCallback(){super.connectedCallback(),this.dropdownOptions.length>0&&!this.selectedOptionValue&&(this.selectedOptionValue=this.dropdownOptions[0].value)}willUpdate(t){t.has("dropdownOptions")&&this.dropdownOptions.length>0&&!this.selectedOptionValue&&(this.selectedOptionValue=this.dropdownOptions[0].value)}_handleOptionClick(t){t.value!==this.selectedOptionValue&&(this.selectedOptionValue=t.value,this.onSelectionChange?.(t.value)),this._closeDropdown()}_getTriggerIcon(){let t=this._getSelectedOption();return t?t.icon:d``}_isOptionSelected(t){return t.value===this.selectedOptionValue}_getTriggerTitle(){let t=this._getSelectedOption();return t?t.title:"Change selection"}_getTriggerLabel(){let t=this._getSelectedOption();return t?`Current selection: ${t.label}`:"No selection"}_getSelectedOption(){return this.dropdownOptions.find(t=>t.value===this.selectedOptionValue)}};a([p({type:String})],Be.prototype,"selectedOptionValue",2),a([p({type:Function})],Be.prototype,"onSelectionChange",2),Be=a([b("single-select-dropdown")],Be);var He=class extends g{constructor(){super(...arguments),this.title=""}render(){return d`
    ...
    `],a([p({type:String})],He.prototype,"title",2),He=a([b("chip-element")],He);var In=d`
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="16"
    height="16"
...
`,Z=class extends g{constructor(){super(...arguments),this.title="Copy to clipboard",this.isCopied=!1,this.copyTimeout=null}handleClick(t){return I(this,null,function*(){if(!this.isCopied){if(this.onCopy)try{yield this.onCopy(t)}catch(e){console.error("Error in onCopy function:",e)}this.isCopied=!0,this.copyTimeout&&clearTimeout(this.copyTimeout),this.copyTimeout=setTimeout(()=>{this.isCopied=!1,this.copyTimeout=null},2e3)}})}disconnectedCallback(){super.disconnectedCallback(),this.copyTimeout&&(clearTimeout(this.copyTimeout),this.copyTimeout=null)}render(){return d`
  ...
  `,a([p({type:String})],Z.prototype,"title",2),a([p({type:Function})],Z.prototype,"onCopy",2),a([u()],Z.prototype,"isCopied",2),a([u()],Z.prototype,"copyTimeout",2),Z=a([b("copy-icon")],Z);var z=class extends g{constructor(){super(...arguments),this.borderColor="#555",this.showCopyButton=!1,this.itemId="",this.isExpanded=!1}toggleExpand(){this.onToggle&&this.onToggle(this.itemId)}handleCopy(t){return I(this,null,function*(){t.stopPropagation();let e=this.shadowRoot?.querySelector('slot[name="details"]');if(e){let i=e.assignedNodes().map(n=>n.textContent).join("");try{yield navigator.clipboard.writeText(i)}catch(n){console.error("Failed to copy text: ",n)}}})}render(){return this.style.setProperty("--border-color",this.borderColor),d`
...
`)}connectedCallback(){super.connectedCallback(),this._abortController=new AbortController;let{signal:t}=this._abortController;this.updateElementListFromManager(),this.updateVisibilityCounts(),f.instance.addEventListener("elementRegistered",e=>{let i=E(C({},e.elementData),{elementId:this.generateElementId()});this.elementListItems.set(e.elementData.element,i),this.updateVisibilityCounts()},{signal:t}),f.instance.addEventListener("elementDataUpdated",e=>{let i=this.elementListItems.get(e.elementData.element);if(i){let n=E(C({},e.elementData),{elementId:i.elementId});this.elementListItems.set(e.elementData.element,n),this.updateVisibilityCounts(),this.requestUpdate()}},{signal:t}),f.instance.addEventListener("elementUnregistered",e=>{this.elementListItems.delete(e.elementData.element),this.updateVisibilityCounts(),this.elementListItems.size||(this.noContentMessage="No Elements Registered To The Foresight Manager"),this.requestUpdate(),this.activeCallbacks.delete(e.elementData.element)},{signal:t}),f.instance.addEventListener("callbackInvoked",e=>{this.activeCallbacks.add(e.elementData.element),this.requestUpdate()},{signal:t}),f.instance.addEventListener("callbackCompleted",e=>{this.handleCallbackCompleted(e.hitType),this.activeCallbacks.delete(e.elementData.element)},{signal:t})}disconnectedCallback(){super.disconnectedCallback(),this._abortController?.abort(),this._abortController=null}updateElementListFromManager(){let t=new Map;f.instance.registeredElements.forEach((e,i)=>{t.set(i,E(C({},e),{elementId:this.generateElementId()}))}),this.elementListItems=t}handleCallbackCompleted(t){switch(t.kind){case"mouse":this.hitCount.mouse[t.subType]++;break;case"tab":this.hitCount.tab[t.subType]++;break;case"scroll":this.hitCount.scroll[t.subType]++;break;default:}this.hitCount.total++,this.requestUpdate()}getSortedElements(){let t=Array.from(this.elementListItems.values());switch(this.sortOrder){case"insertionOrder":return t;case"documentOrder":return t.sort(this.sortByDocumentPosition);case"visibility":return t.sort((e,i)=>e.isIntersectingWithViewport!==i.isIntersectingWithViewport?e.isIntersectingWithViewport?-1:1:this.sortByDocumentPosition(e,i));default:return this.sortOrder,t}}render(){return d`
  ...
  `,a([u()],P.prototype,"hitCount",2),a([u()],P.prototype,"visibleElementsCount",2),a([u()],P.prototype,"totalElementsCount",2),a([u()],P.prototype,"sortDropdown",2),a([u()],P.prototype,"sortOrder",2),a([u()],P.prototype,"elementListItems",2),a([u()],P.prototype,"noContentMessage",2),a([u()],P.prototype,"activeCallbacks",2),a([u()],P.prototype,"expandedElementIds",2),P=a([b("element-tab")],P);var qe=class extends g{constructor(){super(...arguments),this.activeTab="settings",this.tabs=["settings","elements","logs"]}_handleTabClick(t){this.dispatchEvent(new CustomEvent("tab-change",{detail:{tab:t},bubbles:!0,composed:!0}))}render(){return d`
...
Consider using 'Control Panel' only for better performance."
      ...
      <tab-content .noContentMessage=${this.noContentMessage} .hasContent=${!!this.logs.length}>
        ${this.logs.length===0?d`<div class="no-items">${this.getNoLogsMessage()}</div>`:Ne(this.logs,t=>d`
                <single-log
                  .log=${t}
    ...
    `],a([u()],D.prototype,"logDropdown",2),a([u()],D.prototype,"filterDropdown",2),a([u()],D.prototype,"logLocation",2),a([u()],D.prototype,"eventsEnabled",2),a([u()],D.prototype,"logs",2),a([u()],D.prototype,"expandedLogIds",2),a([p()],D.prototype,"noContentMessage",2),D=a([b("log-tab")],D);var Ci="points",Yn="px",Jn="tabs",Xn="ms",Ce=class extends g{constructor(){super(...arguments),this.header="",this.description=""}render(){return d`<div class="setting-item">
      <label>
          ...
          <div class="settings-section">
            <div class="settings-group">
              ...
              <setting-item-range
                ...
                description="How far into the future, in ${Ci}, to calculate mouse trajectory path"
      ...
      <div class="control-wrapper ${this.isMinimized?"minimized":""}">
        ...
        <div class="tab-container ${this.isMinimized?"hidden":""}">
          ...
          <div class="tab-content">
            <log-tab class=${Ve({active:this.activeTab==="logs"})}></log-tab>
            <element-tab class=${Ve({active:this.activeTab==="elements"})}></element-tab>
            <settings-tab
              class=${Ve({active:this.activeTab==="settings"})}
            ></settings-tab>
          </div>
        </div>
      </div>
